...
table(TrueValues=test$Purchase, Predictions=pred_labels)
```
**Key takeaways:**<br>
...
3. Machine Learning 1 legacy: always put true values first in the `table` function, and specify names of rows and columns to make it clear.
...
# Form a confusion matrix
table(TrueValues=test$Purchase, Predictions=knn.labels)
```
**Key takeaways:**<br>
...
17/(17+68)
```
The boosting model performs slightly better in terms of model precision.
<br>
<br>
...
# Form a confusion matrix
table(TrueValues=test$Purchase, Predictions=glm.labels)
```
Calculate the precision of the KNN model.
```{r}
58/(58+350)
